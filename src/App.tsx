...
function App() {
  return (
    <Router>
      ...
      <Suspense fallback={ <div className="flex justify-center items-center h-screen" role="status" >
        <svg aria-hidden="true" className="inline w-[100px] h-[100px] text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
